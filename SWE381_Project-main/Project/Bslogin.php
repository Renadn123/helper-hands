...
if(isset($_POST['submut'])){
            $Email = $_POST['email'];
            $Psw = $_POST['pass'];
            $query_babysitter = "SELECT * FROM `babysitter` WHERE Email = '$Email' AND Passwrd = '$Psw'";
            ...
            if(mysqli_num_rows($result_b) > 0){
                ...
                header("Location:babySitterHomePage.php");
            }
            else {
...
<head>
    ...
    <body>
        ...
        <div class="UTextContainer">
            ...
            <form class="login" action="includes/Bslogin.inc.php" method="post">
